...
// Result/action/state structs (HideResult, AttackResult, Attack, SpellAction, InFlight*,
// NpcTurnState, canTakeReaction(), …) moved to combat_types.hpp — R2 of
// COMBAT_REFACTOR_PLAN.md.
